      ...
      {message.text && (
        <article className={`message is-${message.type ? message.type : ""}`}>
          <div className="message-body">{message.text}</div>
			...
			<div className="field">
				<label className="label is-small" htmlFor="newPassword">Nouveau mot de passe</label>
				<div className="control">
					<input
						id="newPassword"
			...
			<div className="field">
				<label className="label is-small" htmlFor="confirmPassword">Confirmation du mot de passe</label>
				<div className="control">
					<input
						id="confirmPassword"
