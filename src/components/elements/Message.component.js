...
const Message = styled.div`
  ...
  &.is-success {
    background-color: ${LightenDarkenColor(props => props.theme.success, 100)};
    border-color: ${props => props.theme.success};
    color: ${props => props.theme.success};
  }

  &.is-warning {
    background-color: ${LightenDarkenColor(props => props.theme.warning, 100)};
    border-color: ${props => props.theme.warning};
    color: ${props => props.theme.warning};
  }

  &.is-danger {
    background-color: ${LightenDarkenColor(props => props.theme.danger, 100)};
    border-color: ${props => props.theme.danger};
    color: ${props => props.theme.danger};
  }

  &.is-primary {
    background-color: ${LightenDarkenColor(props => props.theme.primary, 150)};
