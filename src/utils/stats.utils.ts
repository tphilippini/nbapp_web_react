export const findTopStats = (stats:any) => {
  let sortedStats = stats.sort((a:any, b:any) => {
...
const formatStats = (stats:any) => {
  ...
  return stats.filter((stat:any) => stat.statsJSON.min !== 0);
};
...
const checkStatType = (stat:any, statsCount?:any) => {
...
const createStatLine = (stat:any, statsCount?:any) => {
  let finalStat = [];
